...
public class clsPOSDayEndProcess {
	...
	public JSONObject funLoadDayEndData(JSONObject jObj) {
		...
		JSONObject jsonObj = objGlobalFunctions.funPOSTMethodUrlJosnObjectData("http://localhost:8080/prjSanguineWebService/WebPOSTransactions/funDayEndProcess", jObj);
	...
	public @ResponseBody ModelAndView funDayEndStart(HttpServletRequest req) {
		...
		try {
			...
			String ShiftNo = "1";
			JSONObject jObj = objGlobalFunctions.funGETMethodUrlJosnObjectData("http://localhost:8080/prjSanguineWebService/DayEndProcessTransaction/funShiftStartProcess?strPOSCode=" + strPOSCode + "&shiftNo=" + ShiftNo);
		...
		return new ModelAndView("frmPOSDayEndProcess");// return jsonDayStart;
														// //new
	...
	public @ResponseBody ModelAndView funDayEndProcess(@RequestParam("emailReport") String EmailReport, HttpServletRequest req) {
		...
		JSONObject jObj = objGlobalFunctions.funPOSTMethodUrlJosnObjectData("http://localhost:8080/prjSanguineWebService/DayEndProcessTransaction/funDayEndProcess", jsonFilter);
