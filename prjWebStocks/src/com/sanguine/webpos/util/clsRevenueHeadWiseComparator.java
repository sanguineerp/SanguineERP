...
public class clsRevenueHeadWiseComparator implements Comparator<clsRevenueHeadWiseSalesReportBean> {

	private List<Comparator<clsRevenueHeadWiseSalesReportBean>> listComparators;

	@SafeVarargs
	public clsRevenueHeadWiseComparator(Comparator<clsRevenueHeadWiseSalesReportBean>... comparators) {
