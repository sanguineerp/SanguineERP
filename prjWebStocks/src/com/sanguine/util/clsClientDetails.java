...
public class clsClientDetails {
	...
	public static void funAddClientCodeAndName() {
		try {
			...
			hmClientDtl.put("211.001", clsClientDetails.createClientDetails("211.001", "CHEFS CORNER", dFormat.parse("2017-11-29"), dFormat.parse("2019-04-16")));//Renewed on 14-03-2019 for 1 month till 16-04-2019//renewed on 15-02-2019 for 1 month till 15-03-2019 //renwed for on emonth on 01-12-2018 till  //renewed  on 30-11-2018 for one month till 30-12-2018  // renewd
		   ...
		   //260.001", "PARAG HOTELS AND RESORT PVT LTD" for POS
			...
			hmClientDtl.put("277.001", clsClientDetails.createClientDetails("277.001", "Kapila Garden Restaurant", dFormat.parse("2018-11-21"), dFormat.parse("2019-04-01")));//Renewed on 16-03-19 for 16 days till 01-04-2019//Renewed on 15-02-2019 for 1 months till 15-03-2019//Renewed on 01-02-2019 for 15 days till 15-02-2019//renewed on 10-01-2019 till 31-01-2019//relased on 21-11-2018 for 1 month till 2018-12-21
			...
			hmClientDtl.put("290.001", clsClientDetails.createClientDetails("290.001", "CREME HOSPITALITY AND MANAGEMENT", dFormat.parse("2018-12-15"), dFormat.parse("2019-04-15"))); ////Renewed on 12-3-2019 for 1 month till 15-4-2019//Renewed on 12-2-2019 for 1 year till 15-12-2019//renewed  for one month on 17-01-2019 form 15-01-2019 till 15-02-2019
			...
			hmClientDtl.put("302.001", clsClientDetails.createClientDetails("302.001", "MOSHING CUPPA", dFormat.parse("2019-03-07"), dFormat.parse("2019-04-07"))); // released on 07-03-2019 for 1 month till 07-04-2019
