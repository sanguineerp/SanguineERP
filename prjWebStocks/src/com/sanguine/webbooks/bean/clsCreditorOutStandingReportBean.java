...
public class clsCreditorOutStandingReportBean
{
	...
	public double getDblOpDrAmt() {
		return dblOpDrAmt;
	}

	public void setDblOpDrAmt(double dblOpDrAmt) {
		this.dblOpDrAmt = dblOpDrAmt;
	}

	public double getDblOpCrAmt() {
		return dblOpCrAmt;
	}
