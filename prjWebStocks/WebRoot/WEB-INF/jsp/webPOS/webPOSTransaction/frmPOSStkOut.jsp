...
<script type="text/javascript">
 ...
 /*On form Load It Reset form :Ritesh 22 Nov 2014*/
	...
	{		
 		 ...
 		 $('input#txtPurchaseBillNo').mlKeyboard({layout: 'en_US'});
 		...
 		$('input#txtQty').mlKeyboard({layout: 'en_US'});
 		$('input#txtPurchaseRate').mlKeyboard({layout: 'en_US'});
 	...
 	function funLoadPOSItemList(code)
	{
 	...
 	function funLoadStockOutDetails(code)
	{
		var searchurl=getContextPath()+"/loadStockOutDetails.html?StockOutCode="+code;
		 $.ajax({
		        ...
		        success: function(response)
		        {
		        	...
		        	{
		        		$("#lblStkOutCode").text(response.strStkOutCode);
		        		$("#txtStkOutCode").val(response.strStkOutCode);
 	...
 	function funAddRow(itemName,itemCode,qty,purchaseRate,amount,externalCode)
	{
	    	...
	    	if(myMap.has(itemCode))
	    	 {
    		    ...
    		    row.insertCell(4).innerHTML= "<input name=\"listOfItem["+(parseInt(dataArr[3]))+"].strItemCode\" readonly=\"readonly\" class=\"Box\" style=\"text-align: left;width:100%\" size=\"10%\" id=\"txtItemCode."+(rowCount)+"\" value="+itemCode+" onclick=\"funGetSelectedRowIndex(this)\"/>";		    
    		    found="Yes";
    		    funResetFields();
	    	 }
	    	cnt++;
	    ...
	    {    
		    ...
		    row.insertCell(4).innerHTML= "<input name=\"listOfItem["+(rowCount)+"].strItemCode\" readonly=\"readonly\" class=\"Box\" style=\"text-align: left;width:100%\" size=\"10%\" id=\"txtItemCode."+(rowCount)+"\" value="+itemCode+" onclick=\"funGetSelectedRowIndex(this)\"/>";		    
		    funResetFields();
	    }	
...
<s:form name="Stock Out" method="POST" action="saveStockOut.html?saddr=${urlHits}" >
	   <div>
	   
	   
	   
	   	<div style="   border-collapse: separate; overflow-x: hidden; overflow-y: scroll; background-color: #C0E2FE;">
		    <br>
		   <table class="masterTable">
			...
			<tr>
				 <td width="300px">
					...
					<s:label id="lblStkOutCode" path="strExternalCode"/>
				 ...
				 <BR>
				    <label>Bill No</label>
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    <s:input  type="text" id="txtPurchaseBillNo" path="strPurchaseBillNo" cssClass="BoxW124px jQKeyboard form-control" required="true"/>
				    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<tr>
			     ...
			     <BR>
			        <label>Select Reason</label>
			            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				        <s:select id="cmbReason" items="${reasonList}" name="cmbReason"  cssClass="BoxW124px jQKeyboard form-control" path="strReasonCode">
						</s:select>
				 ...
				 <td >
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    <s:input  type="text" id="txtItemName" path="strItemName"  cssClass="longTextBox jQKeyboard form-control"   ondblclick="funHelp('POSItemList')"/>
			    </td>
			</tr>
			<tr>
				 <td>
				 <BR>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    <s:input  type="text" id="txtExternalCode" path="strExternalCode" cssClass="BoxW124px jQKeyboard form-control" />
			    </td>
			 ...
			 <td> 
			     Quantity:
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			     <s:input id="txtQty" path="dblQty"  required="true" cssStyle="text-transform: uppercase;" cssClass="BoxW124px jQKeyboard form-control" value="1" />
			     &nbsp;&nbsp;&nbsp;&nbsp;
			     Purchase Rate:
			     &nbsp;&nbsp;&nbsp;&nbsp;
			 ...
			 <s:input type="hidden" id="txtStkOutCode" path="strStkOutCode" />
...
<!-- 			<tr><td ></td></tr> -->
			...
			<td>
			 ...
			 <input id="btnAdd" type="button" class="smallButton" value="OK" onclick="funAddRowDetails();"></input>
			  &nbsp;&nbsp;&nbsp;&nbsp;
			 <input id="btnModifyStkin" type="button" class="smallButton" value="Modify" ondblclick="funHelp('StockOut')"></input>
			</td>
			</tr>	
	     ...
	     <br>
            <div style=" background-color: #C0E2FE; border: 1px solid #ccc; display: block; height: 420px; margin: auto; overflow-x: scroll; overflow-y: scroll; width: 90%;">
					<table id="tblData"
						...
						<td style="border: 1px  white solid;width:10%; text-align: left" ><label>Item Code</label></td>	
