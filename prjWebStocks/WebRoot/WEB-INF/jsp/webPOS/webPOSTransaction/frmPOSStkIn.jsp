		   ...
		   <table class="masterTable">
			...
			<tr>
			     ...
			     <BR>
			        <label>Select Reason</label>
			            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				        <s:select id="cmbReason" items="${reasonList}" name="cmbReason"  cssClass="searchTextBox jQKeyboard form-control" path="strReasonCode">
						</s:select>
			...
			<tr>
			 ...
			 <td> 
			     Quantity:
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      <s:input id="txtQty" path="dblQty"  required="true" cssStyle="text-transform: uppercase;" cssClass="BoxW62px jQKeyboard form-control" value="1" />
			     &nbsp;&nbsp;&nbsp;&nbsp; 
			      Purchase Rate:
			     &nbsp;&nbsp;&nbsp;&nbsp; 
			      <s:input id="txtPurchaseRate" path="dblQty"  required="true" cssStyle="text-transform: uppercase;" cssClass="BoxW62px jQKeyboard form-control" value="0" />
				 </td>
			</tr>
