...
function funSubmit()
{
	...
	document.KDSForm.action="funBillOrderProcess.html?selectedBills="+arrSelectedBills;
...
function myTimer() {
 ...
 function funGetBillHdDtl()
 {
	 funRemoveTableRows("tblOrder");
		
	
		var searchurl=getContextPath()+"/funGetBillHdDtl.html";		
		 $.ajax({
		        type: "GET",
		        ...
		        success: function(response)
		        {
		        	...
		        	arrBillNo =response.BillNo;
		        	arrBillHd=response.BillHd;
 ...
 function funNewBillSize()
 {
	 
	 var searchurl=getContextPath()+"/funGetNewBillSize.html";		
		 $.ajax({
		        type: "GET",
...
<s:form name="KDSForm" method="POST" action="funBillOrderProcess.html">
