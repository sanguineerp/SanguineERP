...
<title>Non Chargeable KOT Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>Non Chargeable KOT </label>
	</div>
	<s:form name="POSNonChargeableSettlementReportForm" method="POST" action="rptNonChargeableSettlementReport.html?saddr=${urlHits}" target="_blank">
