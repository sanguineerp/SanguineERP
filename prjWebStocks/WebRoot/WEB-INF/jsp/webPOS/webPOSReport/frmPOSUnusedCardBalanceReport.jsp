...
<title>Unused Card Balance Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>Unused Card Balance Report</label>
	</div>
	<s:form name="frmPOSUnusedCardBalanceReport" method="POST" action="rptPOSUnusedCardBalanceReport.html?saddr=${urlHits}" target="_blank">
		<br />
		<br />
