...
<body onload="funSetDate()">
	...
	<s:form name="POSAvgItemPerBillReportForm" method="POST" action="rptPOSAvgItemPerBill.html?saddr=${urlHits}" target="_blank">
		...
		<table class="masterTable">
			...
			<tr>				
				...
				<td >
						<s:select id="cmbPosWise" path="strDateWise" cssClass="BoxW124px">
				...
				<td >
						<s:select id="cmbDateWise" path="strPosWise" cssClass="BoxW124px">
				    		<s:option value="NO">NO</s:option>
				    		<s:option value="YES">YES</s:option>
