...
<body onload="funSetDate()">
	<div id="formHeading">
		<label>Tax Wise Report</label>
	</div>
	<s:form name="POSTaxWiseReportForm" method="POST" action="rptPOSTaxWiseSales.html?saddr=${urlHits}" target="_blank">
