...
<title>Non Chargeable Settlement Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>Non Chargeable KOT Report</label>
	</div>
	<s:form name="POSNonChargeableKOTReportForm" method="POST" action="rptNonChargeableKOTReport.html?saddr=${urlHits}" target="_blank">
		...
		<table class="masterTable">
			...
			<tr>
					<td>&emsp;&ensp;&emsp;&ensp;
					<label>Reason Master</label></td>
					<td >
						<s:select id="cmbReasonMaster" path="strReasonMaster" cssClass="BoxW124px" items="${ReasonMasterList}">
				    	</s:select>
					</td>
					<td></td>
