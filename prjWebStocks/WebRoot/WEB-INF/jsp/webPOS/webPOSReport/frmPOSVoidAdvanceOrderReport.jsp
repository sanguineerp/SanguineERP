...
<title>Void Advance Order</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body onload="funSetDate()">
	<div id="formHeading">
		<label>Void Advance Order Report</label>
	</div>
	<s:form name="POSVoidAdvanceOrderReport" method="POST" action="rptPOSVoidAdvanceOrder.html?saddr=${urlHits}" target="_blank">
		...
		<table class="masterTable">
			...
			<tr>
				...
				<td >
						<s:select id="cmbOrderType" path="strOrderType" cssClass="BoxW124px">
						<s:option value="ALL">All</s:option>
				    		<s:option value="ADVANCES ORDER">ADVANCE ORDER</s:option>
				    		<s:option value="URGENT ORDER">URGENT ORDER</s:option>
