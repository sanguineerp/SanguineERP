...
<title>Delivery boy Incentive</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>Delivery boy Incentive</label>
	</div>
	<s:form name="DeliveryboyIncentive" method="POST" action="rptDeliveryboyIncentive.html?saddr=${urlHits}" target="_blank">
		<br />
		<br />
		<table class="masterTable">
			...
			<tr>
				<td>&emsp;&ensp;&emsp;&ensp;
					<label>Delivery Boy Name</label></td>
					<td>
						<s:select id="cmbDeliveryBoyName" path="strDeliveryBoyName" cssClass="BoxW124px" items="${DeliveryBoyList}">
				    	</s:select>
					</td>
					<td></td>
				</tr>
