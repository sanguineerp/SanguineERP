...
<body onload="funSetDate()">
	<div id="formHeading">
		<label>Discount Wise Sales Report</label>
	</div>
	<s:form name="POSDiscountWiseReportForm" method="POST" action="rptPOSDiscountWiseSales.html?saddr=${urlHits}" target="_blank">
