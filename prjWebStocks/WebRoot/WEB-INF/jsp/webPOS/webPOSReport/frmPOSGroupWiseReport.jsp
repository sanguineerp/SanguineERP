...
<body >
	...
	<s:form name="POSGroupWiseReportForm" method="POST" action="rptPOSGroupWiseSales.html?saddr=${urlHits}" target="_blank">
		...
		<table class="masterTable">
			...
			<tr>
				...
				<td><s:select id="cmbSGName" name="cmbSGName" path="strSGName" cssClass="BoxW124px" items="${listSubGroup}" ></s:select></td>
