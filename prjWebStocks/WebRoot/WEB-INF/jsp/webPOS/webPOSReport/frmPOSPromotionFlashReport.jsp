...
<title>Promotion Flash Report</title>
<style>
.ui-autocomplete {
	max-height: 200px;
	overflow-y: auto;
...
<br/>
	...
	<div id="formHeading">
		...
		<label>Promotion Flash Report</label>
	</div>
	<br/>
	 <s:form name="POSPormotionFlashReportForm" method="POST" action="rptPromotionFlashReport.html?saddr=${urlHits}" target="_blank"> 
			...
			<tr>
					...
					<label>Promotion Code</label></td>
					<td>
						<s:select id="cmbPromotionCode" path="strPromotionCode" cssClass="BoxW124px" items="${PromotionList}">
				    	</s:select>
					</td>
					<td></td>
				</tr>
