...
<title>Credit Bill Outstanding  Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>Credit Bill Outstanding  Report</label>
	</div>
	<s:form name="POSCreditBillOutstandingReportForm" method="POST" action="rptPOSCreditBillOutstandingReport.html?saddr=${urlHits}" target="_blank">
