...
<body onload="funSetDate()">
	...
	<s:form name="POSComplimentarySettlementForm" method="POST" action="rptPOSComplimentarySettlement.html?saddr=${urlHits}" target="_blank">
		...
		<table class="masterTable">
			...
			<tr>
				...
				<td colspan="3"><s:input id="txtFromDate" required="required" path="fromDate" pattern="\d{1,2}-\d{1,2}-\d{4}" cssClass="calenderTextBox"/></td>
				</tr>
				<tr>
				<td><label>To Date</label></td>
				<td colspan="3"><s:input id="txtToDate" required="required" path="toDate" pattern="\d{1,2}-\d{1,2}-\d{4}" cssClass="calenderTextBox"/></td>
			...
			<tr>
					<td><label>Reason Master</label></td>
					
					<td ><s:select id="cmbDocType" name="cmbDocType" path="strReasonCode" cssClass="BoxW124px" items="${reasonList}" >
