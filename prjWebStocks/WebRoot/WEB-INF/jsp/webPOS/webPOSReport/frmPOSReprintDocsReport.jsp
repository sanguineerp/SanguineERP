...
<body >
	...
	<s:form name="frmPOSReprintDocsReport" method="POST" action="rptReprintDocsReport.html?saddr=${urlHits}" target="_blank">
		...
		<tr>
			...
			<tr>
				...
				<td><s:select id="cmbUser" name="cmbUser"
						path="strUserCreated" cssClass="BoxW124px" items="${listUser}"></s:select></td>

				<td><label>Report Type</label></td>
				<td><s:select id="cmbDocType" path="strDocType"
						cssClass="BoxW124px" >
				<option  value="A4 Size Report">A4 Size Report</option>
				<option  value="Text File 40 Column Report">Text File 40 Column Report</option>
			...
			<td><label> Type</label></td>
				<td><s:select id="cmbType" path="strViewType"
						cssClass="BoxW124px">
				...
				<td><s:select id="cmbType" path="strViewBy"
						cssClass="BoxW124px" items="${DocNoList}">
