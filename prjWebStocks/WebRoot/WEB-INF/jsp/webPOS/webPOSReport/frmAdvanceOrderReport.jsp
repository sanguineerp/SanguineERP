...
<title>Advance Order Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	...
	<s:form name="AdvanceOrderReport" method="POST" action="rptAdvanceOrderReport.html?saddr=${urlHits}" target="_blank">
		<br />
		<br />
		<table class="masterTable">
			...
			<tr>
					<td>&emsp;&ensp;&emsp;&ensp;
					<label>Order Type</label></td>
					<td >
						<s:select id="cmbSelectType" path="strType" cssClass="BoxW124px">
				    		<s:option value="All">All</s:option>
				    		<s:option value="Advance Order">Advance Order</s:option>
