...
<title>Waiter Wise Incentives Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>Waiter Wise Incentives Report</label>
	</div>
	<s:form name="WaiterWiseIncentivesReport" method="POST" action="rptWaiterWiseIncentivesReport.html?saddr=${urlHits}" target="_blank">
		<br />
		<br />
