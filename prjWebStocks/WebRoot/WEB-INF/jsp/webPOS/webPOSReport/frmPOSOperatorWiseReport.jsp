...
<body onload="funSetDate()">
	...
	<s:form name="POSPOSOperatorWiseReport" method="POST" action="rptPOSOperatorWiseReport.html?saddr=${urlHits}" target="_blank">
		...
		<table class="masterTable">
			...
			<td><label>Settlement Type</label></td>
					<td >
						<s:select id="cmbSettlementType" name="cmbSettlementType" path="strReportType" cssClass="BoxW124px" items="${settlementList}">
				    	</s:select>
					</td>
			</tr>
		</table>
