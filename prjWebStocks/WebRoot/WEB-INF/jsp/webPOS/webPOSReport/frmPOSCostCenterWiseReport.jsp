...
<body onload="funSetDate()">
	<div id="formHeading">
		<label>Cost Center Wise Report</label>
	</div>
	<s:form name="POSCostCenterWiseReportForm" method="POST" action="rptPOSCostCenterWiseReport.html?saddr=${urlHits}" target="_blank">
		...
		<table class="masterTable">
			...
			<tr>
				<td width="140px">Cost Center Name</td>
				<td colspan="3"><s:select id="cmbSGName" name="cmbSGName" path="strSGName" cssClass="BoxW124px" items="${costCenterList}" >
