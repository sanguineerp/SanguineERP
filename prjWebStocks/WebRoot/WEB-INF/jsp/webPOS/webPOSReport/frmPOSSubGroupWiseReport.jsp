...
<body onload="funSetDate()">
	<div id="formHeading">
		<label>Sub Group Wise Sales Report</label>
	</div>
	<s:form name="POSSubGroupWiseReportForm" method="POST" action="rptPOSSubGroupWiseSales.html?saddr=${urlHits}" target="_blank">
