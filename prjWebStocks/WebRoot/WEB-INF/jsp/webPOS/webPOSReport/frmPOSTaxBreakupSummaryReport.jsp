...
<title>Tax Breakup Summary Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>Tax Breakup Summary Report</label>
	</div>
	<s:form name="POSTaxBreakupSummaryReport" method="POST" action="rptTaxBreakupSummaryReport.html?saddr=${urlHits}" target="_blank">
