...
<title>SubGroup Wise Summary Report</title>
<style>
.ui-autocomplete {
    max-height: 200px;
    overflow-y: auto;
...
<body >
	<div id="formHeading">
		<label>SubGroup Wise Summary Report</label>
	</div>
	<s:form name="POSSubGroupWiseSummaryReportForm" method="POST" action="rptPOSSubGroupWiseSummary.html?saddr=${urlHits}" target="_blank">
