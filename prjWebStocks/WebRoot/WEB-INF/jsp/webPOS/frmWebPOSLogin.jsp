...
function btnSubmit_onclick() 
{
	...
	var strurl= getContextPath()+"/ConfrimLoginWebPOS.html?userName="+strUserName+"&password="+strpassword;
...
<div style="width: 100%; height: 40px; background-color: #458CCA">
	...
	<s:form id="frmWebPOSLogin" name="frmWebPOSLogin"  action="ConfrimLoginWebPOS.html" >
	<div
