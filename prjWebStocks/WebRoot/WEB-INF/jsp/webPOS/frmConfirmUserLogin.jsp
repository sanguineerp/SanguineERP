...
<script type="text/javascript">
	...
	function btnSubmit_onclick() 
	{
		...
		var strurl= getContextPath()+"/confirmUserLogin.html?userName="+strUserName+"&password="+strpassword;
				...
				$.ajax({				
					    ...
					    {	
								...
								if(str=="Invalid Login")
									...
									{
									var alldata = {str:str,strUserName:strUserName};
...
<div style="width: 100%; height: 40px; background-color: #458CCA">
	...
	<div
		...
		<table  class="masterTable" style="width: 100%">
			<tr>
								<td width="100px" style="padding-left: 30px">User Name</td>
