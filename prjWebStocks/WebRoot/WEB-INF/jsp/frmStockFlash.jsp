...
<head>
	...
	<script type="text/javascript">
		...
		function pageselectCallback(page_index, jq)
		{
		    ...
		    if($("#cmbReportType").val()=='Summary') 
		    {
			   	newcontent = '<table id="tblStockFlash" class="transTablex" style="width: 100%;font-size:11px;font-weight: bold;"><tr bgcolor="#75c0ff"><td id="labls1">Property Name</td><td id="labls2">Product Code</td><td id="labls3">Product Name</td><td id="labls4">Location</td><td id="labls5">Group</td><td id="labls6">Sub Group</td><td id="labls7">UOM</td><td id="labls8">Bin No</td><td id="labls9">Weighted Avg Price</td><td id="labls10">Opening Stock</td><td id="labls11">Receipts</td><td id="labls12">Issue</td><td id="labls13">Closing Stock</td><td id="labls14">Value</td><td id="labls15">Issue UOM Stock</td><td id="labls16">Issue Conversion</td><td id="labls17">Issue UOM</td><td id="labls18">Part No</td></tr>';
