...
// 			document.recipeForm.submit();
		...
		function funLoadBomData(strChildCode,strProdName,dblQty,strUOM)
		{
		    ...
		    row.insertCell(1).innerHTML= "<input class=\"Box\" size=\"70%\" name=\"listBomDtlModel["+(rowCount)+"].strProdName\"  id=\"lblItemName."+(rowCount)+"\" value='"+strProdName+"' >";
		    ...
		    row.insertCell(3).innerHTML= "<input class=\"Box\" size=\"6%\" name=\"listBomDtlModel["+(rowCount)+"].strUOM\" id=\"lblUOM."+(rowCount)+"\" value="+strUOM+">";
	...
	<input type="hidden" value="${urlHits}" name="saddr">
		<br>
			<table  class="transTable">
			    ...
			    <tr>
			        <td><label id="lblRecipeCode" ></label></td>
			        <td><s:input id="txtBomCode" path="strBOMCode" readonly="true" ondblclick="funHelp('bomcode')" cssClass="searchTextBox"/></td>			        
			        <td><label>Parent Product</label></td>
			        <td ><s:input id="txtParentCode" required="true" path="strParentCode"  ondblclick="funHelp('productProduced')" cssClass="searchTextBox"/>
